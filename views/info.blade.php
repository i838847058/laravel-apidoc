...
@section('content')
    <div class="container">
        <div class="jumbotron" style="background-color: #fff;">
            ...
            <p class="text-primary">{{ isset($doc['title']) ? $doc['title'] : '请设置title注释' }}
                -- {{ isset($doc['author']) ? $doc['author'] : '请设置auhtor注释' }}</p>
            <br/>
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade in" id="test">
                    <br>
                    <!--head-->
                    <div class="panel panel-primary" style="border-color: #3BCAB4">
                        <div class="panel-heading" style="border-color: #3BCAB4;background-color: #3BCAB4">
                        ...
                        <div class="panel-body">
                            <form id="apiform" class="form-horizontal" role="form">
                                    ...
                                    @foreach($doc['header'] as $header)
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label"><span
                                                        class="badge">header</span> {{ isset($header['name']) ? $header['name'] : '' }}
                                            </label>
                                            <div class="col-sm-7">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        <select class="form-control" name="method_type">
                                            <option value="GET"
                                                    @if(isset($doc['method']) && strtoupper($doc['method']) == 'GET') selected @endif>
                                                GET
                                            </option>
                                            <option value="POST"
                                                    @if(isset($doc['method']) && strtoupper($doc['method']) == 'POST') selected @endif>
                                                POST
                                            </option>
                                            <option value="PUT"
                                                    @if(isset($doc['method']) && strtoupper($doc['method']) == 'PUT') selected @endif>
                                                PUT
                                            </option>
                                            <option value="DELETE"
                                                    @if(isset($doc['method']) && strtoupper($doc['method']) == 'DELETE') selected @endif>
                                                DELETE
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        <textarea class="form-control" type="text"
                                                  name="cookie">{{ http_build_query($_COOKIE,'',';') }}</textarea>
                                    </div>
                                    <div class="col-sm-2"></div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        <button type="button" class="btn btn-warning" data-toggle="modal"
                                                data-target="#addParamModal">
                                            <span class="glyphicon glyphicon-plus"></span> 增加参数
                                        </button>
                                    </div>
                                    <div class="col-sm-2"></div>
                                </div>
                                @if(isset($doc['param']) && is_array($doc['param']) && !empty($doc['param']))
                                    @foreach($doc['param'] as $param)
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">{{ isset($param['name']) ? $param['name'] : '' }}</label>
                                            <div class="col-sm-7">
                                                <input class="form-control" type="text"
                        ...
                        <div class="panel-body" id="span_result">
                            <div class="form-inline result_body">
                                <button type="button" class="btn btn-info" data-toggle="modal"
                                        data-target="#addJosnTextmModal">自定义解析数据
                                </button>
                                <label>缩进量:</label>
                ...
                <div class="modal-body">
                    <form class="form-horizontal" role="form">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" name="jsonText"
